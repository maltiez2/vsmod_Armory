...
if __name__ == "__main__":
    replace_in_folder("../../resources/assets/*/shapes/**/*", '"game:block/', '"block/')
    replace_in_folder("../../resources/assets/*/shapes/**/*", '"game:item/', '"item/')
    replace_in_folder("../../resources/assets/*/shapes/**/*", '"game:entity/', '"entity/')
